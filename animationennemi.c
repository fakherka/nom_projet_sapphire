...
perso Initperso(perso Ennemie,SDL_Rect position)
{
...
void  AfficherEnemy(perso Ennemie,SDL_Surface *screen,SDL_Rect camera)
{
...
perso MoveEnemy(perso Ennemie,SDL_Rect personnage)
{
